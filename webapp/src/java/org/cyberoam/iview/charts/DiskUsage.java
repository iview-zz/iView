 ...
 *
 */
class CustomToolTipGeneratorForDiskUsage extends StandardPieToolTipGenerator {
	private String formatString = null; 
	CustomToolTipGeneratorForDiskUsage(){
		formatString = super.getLabelFormat();
	}
	CustomToolTipGeneratorForDiskUsage(String formatString ){
