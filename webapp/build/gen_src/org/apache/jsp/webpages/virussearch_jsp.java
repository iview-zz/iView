...
public final class virussearch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.print( TranslationHelper.getTranslatedMessge("Search Anti Virus Report") );
      ...
      out.print( TranslationHelper.getTranslatedMessge("HTTP") );
      out.write("\n\t\t\t\t<input type=radio name=application value=\"https\" onclick =\"\" id=\"https\">\n\t\t\t   \t");
      out.print( TranslationHelper.getTranslatedMessge("HTTPS") );
      out.write("\n\t\t\t\t<input type=radio name=application value=\"ftp\" onclick =\"\" id=\"ftp\">\n\t\t\t   \t");
      out.print( TranslationHelper.getTranslatedMessge("FTP") );
      ...
      out.print( TranslationHelper.getTranslatedMessge("Any") );
      out.write("\n\t\t\t</td>\n\t\t</TR>\n\t\t<TR>\n\t\t\t<TD>\n\t\t\t\t");
      out.print( TranslationHelper.getTranslatedMessge("User Email Address") );
      ...
      out.print( TranslationHelper.getTranslatedMessge("Virus Name") );
