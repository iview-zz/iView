...
void
oppgtrigger_log_msg(int level, char *fmt, ...)
{
...
void
oppgtrigger_assert(const char *msg, const char *file, int line)
{
    oppgtrigger_log_msg(LG_ERR, "file: %s:%d, Assertion '%s' failed\n", file, line, msg);
