...
//	handle1 = dlopen("/usr/local/garner/garner/plugins/OutputPlugin/libpgtrigger/liboppgtrigger.so", RTLD_LAZY);
	handle1 = dlopen("/usr/local/garner/garner/plugins/OutputPlugin/libpgtrigger/liboppgtrigger.so", RTLD_LAZY);

	debug1=dlsym(handle1,"oppgtrigger_debug");
	init1=dlsym(handle1,"oppgtrigger_init");
	output1=dlsym(handle1,"oppgtrigger_output");
	close1=dlsym(handle1,"oppgtrigger_close");
	event1=dlsym(handle1,"oppgtrigger_event");
