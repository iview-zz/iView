...
#ifndef _CYBEROAM_OP_RESOLVER_H_
#define _CYBEROAM_OP_RESOLVER_H_
 ...
 */
int resolver_init(const char *argstring, u_int32_t version, void **handle);
/*
 * Frees the internal data-structures of the library.
 */
void resolver_close(void *handle);

/*
 * Description:
 *	Output plugin, can be formatter or processor
 */
void resolver_output(struct _std_event *searray, u_int32_t nse,
                          struct _output_data **output_data_list, void *handle);

void resolver_debug(void);
