...
#ifndef _CYBEROAM_OP_SETHRESHOLD_H_
#define _CYBEROAM_OP_SETHRESHOLD_H_
 ...
 */
int sethreshold_init(const char *argstring, u_int32_t version, void **handle);
/*
 * Frees the internal data-structures of the library.
 */
void sethreshold_close(void *handle);

/*
 * Description:
 *	Output plugin, can be formatter or processor
 */
void sethreshold_output(struct _std_event *searray, u_int32_t nse,
